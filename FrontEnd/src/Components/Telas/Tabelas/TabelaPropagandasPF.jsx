...
import { excluirPropagandaPF, baixarArquivo, atualizarArquivosAdicionais } from "../../../Services/propagandaPFService"; 
import { FaTrash, FaEdit, FaInfoCircle, FaDownload, FaExternalLinkAlt, FaPlus } from "react-icons/fa";
import { consultarPorRole, vincularUsuarioPropaganda } from "../../../Services/usersService";

export default function TabelaPropagandasPF(props) {
    ...
    function handleExcluirPropagandaPF(propaganda) {
        const token = contextoUsuario.usuarioLogado.token;
        if (window.confirm(`Deseja excluir a propaganda "${propaganda.nome}" do cliente ${propaganda.cliente_cpf}?`)) {
            excluirPropagandaPF(propaganda, token)
                .then((resposta) => {
    ...
    function handleDownloadArquivo(nomeArquivo, cpf) {
        const token = contextoUsuario.usuarioLogado.token;
        baixarArquivo(nomeArquivo, cpf, token)
            .catch((error) => {
    ...
    function onVincularUsuario(userId) {
        ...
        const prop_publ = "propF"; // Define o valor para a coluna `prop_publ`
    ...
    return (
        <Container>
                        ...
                        <tr key={propaganda.id}>
                            ...
                            <td className="text-nowrap">
                                <FaEdit
                                    ...
                                    onClick={() => {
                                        props.setPropagandaSelecionada(propaganda);
                                ...
                                <FaTrash
                                    ...
                                    onClick={() => handleExcluirPropagandaPF(propaganda)}
                                />
                                <FaInfoCircle
            ...
            <Modal show={showModal} onHide={handleCloseModal} centered size="xl" className="modal-custom-width">
                    ...
                    {selectedPropaganda && (
                        <Container>
                            <Row className="mb-3">
                                ...
                                <Col md="auto">
                                    <strong>CPF:</strong> {selectedPropaganda.cliente_cpf}
                                </Col>
                                <Col md="auto">
                                                            ...
                                                            <FaDownload
                                                                ...
                                                                onClick={() =>
                                                                    handleDownloadArquivo(
                                                                        arquivo.trim(),
                                                                        selectedPropaganda.cliente_cpf
                                                                    )
                                                                }
                                                            />
                                                        </li>
